...
{
    public class PayPalController : BootstrapBaseController
    {
        ...
        public ActionResult RedirectFromPayPal()
        {
            try
            {
                ...
                using (IPaymentRepository paymentRepository = new PaymentRepository())
                    redirectFromPayPalModel = new PayPalBR().ProcessRedirectFromPayPal(strResponse, paymentRepository, new EmailBR());
        ...
        public void NotifyFromPayPal()
        {
            ...
            new PayPalBR().ProcessNotifyFromPayPal(strRequest, strResponseStatus, paymentRepository, answerRepository, new EmailBR());
